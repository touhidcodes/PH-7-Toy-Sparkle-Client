...
const FindMore = () => {
  return (
    <div className="mt-20">
      <div className="grid grid-cols-1 bg-gray-100 lg:grid-cols-4  p-10 rounded-sm">
        <div className="col-span-3 pr-20 flex flex-col justify-center">
          <h1 className="text-2xl lg:text-5xl font-semibold text-gray-700">
